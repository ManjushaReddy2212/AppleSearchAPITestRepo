...
public class ResponseItemValidator {
    ...
    public void validateSongItem() {
        ...
        final HashSet<String> attributes = new HashSet<String>((Arrays.asList("wrapperType", "kind", "artistId", "collectionId", 
                                                                               "trackId", "artistName", "collectionName", "trackName", 
                                                                              "collectionCensoredName", "trackCensoredName", "artistViewUrl", 
    ...
    public void validateAudioBookItem() {
        ...
        final HashSet<String> audioBookatAttributes = new HashSet<String>((Arrays.asList("wrapperType", "collectionId", "artistName", "collectionName",
                                                                                         "collectionCensoredName", "artistViewUrl", "collectionViewUrl", 
                                                                                         "artworkUrl60", "artworkUrl100", "collectionPrice", "trackCount", 
                                                                                         "releaseDate", "collectionExplicitness", "country", "currency", 
                                                                                         "primaryGenreName", "previewUrl", "description")));    
    ...
    public void validateFeatureMovieItem() {
        ...
        final HashSet<String> featureMovieattributes = new HashSet<String>((Arrays.asList("wrapperType", "kind", "trackId", "trackName",
                                                                                           "artistName", "country", "currency", "primaryGenreName",
                                                                                           "trackCensoredName","previewUrl","releaseDate","collectionExplicitness",
    ...
    public void validateEBookItem() {
        ...
        final HashSet<String> ebookAttributes = new HashSet<String>((Arrays.asList("artistId", "kind", "price", "artistName", "description", 
                                                                                    "trackId", "trackId", "releaseDate", "currency")));           
    ...
    public void validatesoftwareItem() {
        ...
        final HashSet<String> softwareAttributes = new HashSet<String>((Arrays.asList("trackId", "kind", "trackName", "minimumOsVersion",
                                                                                       "version", "currentVersionReleaseDate", "features", "currency")));    
    ...
    public void validatePodcastItem() {
        ...
        final HashSet<String> podCastattributes = new HashSet<String>((Arrays.asList("wrapperType", "kind", "collectionId", "trackId", "artistName",
                                                                                      "collectionName", "country", "currency", "primaryGenreName")));    
    ...
    public void validateTVEpisodeItem() {
        ...
        final HashSet<String> tvEpisideAttributes = new HashSet<String>((Arrays.asList("wrapperType", "kind", "collectionId", "artistId",
                                                                                        "artistName","collectionName", "trackId", "trackName", 
                                                                                        "collectionCensoredName", "country", "currency")));       
    ...
    public void validateMusicVideoItem() {
        ...
        final HashSet<String> musicVideoattributes = new HashSet<String>((Arrays.asList("wrapperType", "kind", "trackId", "artistId", 
                                                                                        "artistName", "country", "trackName", "currency")));   
